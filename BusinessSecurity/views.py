        ...
        if request.user.business_user.privilege == 'general_staff':
            ...
            if request.method == 'POST':
                ...
                notification = models.AdminNotification.objects.create(category_choice='bcs',
                                                                       ...
                                                                       notification=f'Got a New Quotation. ID: {order[0].id} <div><a href="https://techforing.com/bcs_admin_order_detail/{order[0].id}/" target="_blank" class="btn btn-success mt-2">Visit Now</a></div>')
                notification.save()
                                ...
                                if quotation.agreement == 'agree':
                                    ...
                                    notification = models.AdminNotification.objects.create(category_choice='bcs',
                                                                                           ...
                                                                                           notification=f'User Agreed to NDA/NCA for quotation: {current_quotation.id}. '
                                                                                                        f'<div><a href="https://techforing.com/bcs_admin_order_detail/{current_quotation.id}/" target="_blank" class="btn btn-success mt-2">Visit Now</a></div>')
                                    notification.save()
                                else:
                                    notification = models.AdminNotification.objects.create(category_choice='bcs',
                                                                                           business=request.user.business_user.business,
                    ...
                    for mail in emails:
                        try:
                            ...
                            send_mail(
                                ...
                                f'An account has been created at https://techforing.com\n'
            ...
            if request.method == 'POST':
                ...
                if extension not in ['php', 'exe', '', 'html', 'htm', 'asp']:
                    ...
                    if form.is_valid():
                        ...
                        notification = models.AdminNotification.objects.create(category_choice='bcs',
                                                                               business=request.user.business_user.business,
                                                                               notification=f'New Ticket Created. <div><a href="https://techforing.com/bcs_admin_tickets_detail/{ticket.id}/" target="_blank" class="btn btn-success mt-2">Visit Now</a></div>')
                        notification.save()
        ...
        if request.user.business_user.privilege == 'general_staff':
            ...
            if request.method == 'POST':
                ...
                if commentform.is_valid():
                    ...
                    notification = models.AdminNotification.objects.create(category_choice='bcs',
                                                                           business=request.user.business_user.business,
                                                                           notification=f'New Comment on Ticket. <div><a href="https://techforing.com/bcs_admin_tickets_detail/{ticket.id}/" target="_blank" class="btn btn-success mt-2">Visit Now</a></div>')
                    notification.save()
            ...
            if form.is_valid():
                ...
                try:
                    send_mail(
                        ...
                        f'Please visit: https://techforing.com/bcs_user_order_details/{current_order.id}/ for more info',
                ...
                notification = models.Notification.objects.create(
                    ...
                    notification=f'Price Set for Order ID: {current_order.id} <div><a href="https://techforing.com/bcs_user_order_details/{current_order.id}/" '
            ...
            if quotation_form.is_valid():
                ...
                try:
                    if current_order.quotation_order.nda.url:
                        nda_url = "https://techforing.com/"+current_order.quotation_order.nda_and_nca.url
                except:
                        nda_url = 'No NDA and NCA'
                try:
                    if current_order.quotation_order.invoice.url:
                        invoice_url = "https://techforing.com/"+current_order.quotation_order.invoice.url
                except:
                ...
                send_mail(
                    ...
                    f'has been set for your order ID: {current_order.id} '
                    f'Please sign them and submit a copy to https://techforing.com/bcs_user_order_details/{current_order.id}/ '
                    f'Please visit: https://techforing.com/bcs_user_order_details/{current_order.id}/ for more info',
                    'admin@techforing.com',
                    q_mail,
                    fail_silently=False,
                ...
                notification = models.Notification.objects.create(
                    ...
                    notification=f'Quotation Set for Order ID: {current_order.id} <div><a href="https://techforing.com/bcs_user_order_details/{current_order.id}/" '
                                 f'target="_blank" class="btn '
                                 f'btn-success mt-2">Visit Now</a></div>',
                    notification_time=timezone.now())
                notification.save()
        ...
        try:
            ...
            if request.method == 'POST':
                ...
                if quotation_form.is_valid():
                    ...
                    send_mail(
                        f'Quotation Set for order ID: {current_order.id}',
                        f'NDA: https://techforing.com/{current_order.quotation_order.nda.url} '
                        f'NCA: https://techforing.com/{current_order.quotation_order.nca.url} '
                        f'has been set for your order ID: {current_order.id} '
                        f'Please sign them and submit a copy to https://techforing.com/bcs_user_order_details/{current_order.id}/ '
                        f'Please visit: https://techforing.com/bcs_user_order_details/{current_order.id}/ for more info',
                        'admin@techforing.com',
...
def bcsAdminSubscriptionDetailView(request, id):
    if request.user.is_superuser or request.user.is_bcs_head:
        ...
        try:
            ...
            #     f'Price Set for order ID: {current_order.id}',
            #     f'has been set for your order ID: {current_order.id} '
            #     f'Please visit: https://techforing.com/bcs_user_subscription_details/{current_order.id}/ for more info',
            #     'admin@techforing.com',
            #     [current_order.user.business_user.business.email],
            #     fail_silently=False,
            # )
    ...
    if request.method == 'POST':
        ...
        if commentform.is_valid():
            ...
            notification = models.Notification.objects.create(
                ...
                notification=f'New Reply on Ticket. <div><a href="https://techforing.com/ticket_details/{ticket.id}/" '
                             f'target="_blank" class="btn '
                             f'btn-success mt-2">Visit Now</a></div>',
                notification_time=timezone.now())
            notification.save()
