...
def cryptoScamView(request,*args,**kwargs):
    context = {

    }
    return render(request, 'mspages/pages/crypto_scam_investigation.html', context)    
            ...
            if quotation_form.is_valid():
                ...
                try:
                    if current_order.quotation_order.nda_and_nca.url:
                        nda_url = "https://techforing.com/"+current_order.quotation_order.nda.url
                except:
